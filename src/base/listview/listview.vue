<template>
  <scroll ref="listview" class="listview" :data="data" :listenScroll="listenScroll"  @scroll="scroll" :probeType="3">
    <ul>
    ...
    <div class="list-shortcut" @touchstart="onShortcutTouchStart" @touchmove.stop.prevent="onShortcutTouchMove">
      <ul >
        <li :class="{'current':currentIndex===index}" v-for="(item,index) in shortcutList" class="item" :key="item" :data-index="index"> {{item}}</li>
      </ul>
    </div>
  ...
  watch: {
    ...
    scrollY(newY) {
      ...
      for (let i = 0; i < listHeight.length; i++) {
        ...
        console.log(height2, height1, newY)
